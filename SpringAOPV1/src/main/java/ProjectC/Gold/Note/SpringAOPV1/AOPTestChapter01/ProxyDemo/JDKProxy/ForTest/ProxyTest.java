...
import ProjectC.Gold.Note.SpringAOPV1.AOPTestChapter01.ProxyDemo.JDKProxy.Proxy.JDKInvocationHandler;
...
public class ProxyTest {
    ...
    private static void saveGeneratedJDKProxyFiles() {
        ...
        try {
            fileOutputStream = new FileOutputStream("src\\main\\webapp\\AOPTestChapter01\\Proxy\\JDKProxy\\ProductService.class");
